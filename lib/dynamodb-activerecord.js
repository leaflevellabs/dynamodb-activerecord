(function () {
    ...
    /**
     * Validates the metadata against existing database.  Should be used cautiously.
     * @param client
     * @param metadata
     * @param createmissing
     */
    exports.validatemetadata = function validatemetadata(client, metadata, createmissing)
    {
    ...
    ar.prototype._generateddbrequestobject = function _generateddbrequestobject(options)
    {
    ...
    ar.prototype.save = function saverecord(client, options)
    {
        var requestobj = this._generateddbrequestobject(options);

    }

    ar.prototype.delete = function deleterecord(client)
    {
